...
export default function Nearby(){
	return (
		<div className={'ejtExperience'}>
			<h3>Nearby Creative</h3>
			...
			<ul>
				...
				<li>Create mobile application using ReactNative.</li>
				<li>Implement third-party services and APIs into existing or new web applications.</li>
			</ul>
		</div>	
	);
}
